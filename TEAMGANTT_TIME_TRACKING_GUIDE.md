...
- TeamGantt API Token: `46|osh01wrIi9VO2xwSmNxbPoOW5rVWHqTCarnJF86Ac777f3b2`
- Project ID: `4336931`
...
curl -X PATCH \
  -H "Authorization: Bearer 46|osh01wrIi9VO2xwSmNxbPoOW5rVWHqTCarnJF86Ac777f3b2" \
  -H "Content-Type: application/json" \
  -d '{"estimated_hours": 2}' \
...
```bash
#!/bin/bash
TOKEN="46|osh01wrIi9VO2xwSmNxbPoOW5rVWHqTCarnJF86Ac777f3b2"
